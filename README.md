...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/renaldotriansah.git
	* cd instagram-tools
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/renaldotriansah/igpriv.git)
...
## For TERMUX ONLY:
	...
	* pkg install git
	* pkg install nodejs
	* git clone https://github.com/renaldotriansah/igpriv.git
	* cd instagram-tools
	* unzip node_modules.zip
	* ls
	* Then select the tool you want to use!
